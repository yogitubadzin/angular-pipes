...
/* harmony import */ var _convert_pipe__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./convert.pipe */ "./src/app/convert.pipe.ts");
...
let ConvertPipe = class ConvertPipe {
    transform(value, targetUnits) {
        if (!value) {
            return '';
        }
        switch (targetUnits) {
...
module.exports = __webpack_require__(/*! C:\Users\tkolodziejczyk\Downloads\pipes+-+013+-+Complete (1)\src\main.ts */"./src/main.ts");
